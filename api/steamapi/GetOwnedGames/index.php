...
if (is_numeric($steamid)) {
    $url = "http://api.steampowered.com/IPlayerService/GetOwnedGames/v0001/?key=".Config::SteamApiKey."&steamid=".$steamid."&include_appinfo=".$include_appinfo."&include_played_free_games=".$include_played_free_games."&format=json";
